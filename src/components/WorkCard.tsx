...
const WorkCard: FC<Props> = ({
  ...
  return (
    ...
    >
      ...
      <p className="font-medium text-xl tracking-wider name-gradient">
        {title}
      </p>
      <p className="text-white-secondary">{description}</p>
      <p className="text-white-secondary">{note}</p>
      <div className="flex items-center space-x-2 font-medium text-xs !mt-10">
        <a
          href={repoLink}
          target="_blank"
          rel="noreferrer"
